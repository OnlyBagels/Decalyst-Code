# Run Aider with DeepSeek V4 Pro via the OpenAI-compatible endpoint.
...
Write-Host "> aider --model openai/deepseek-v4-pro  (base: $base)"
$env:OPENAI_API_BASE = $base
$env:OPENAI_API_KEY  = $env:DEEPSEEK_API_KEY
& aider --model openai/deepseek-v4-pro @args
